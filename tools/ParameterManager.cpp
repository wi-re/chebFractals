...
std::string to_string(int4 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + ", " + std::to_string(rhs.z()) + ", " + std::to_string(rhs.w()) + "]"; }

std::string to_string(float3 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + ", " + std::to_string(rhs.z()) + "]"; }
std::string to_string(double3 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + ", " + std::to_string(rhs.z()) + "]"; }
std::string to_string(int3 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + ", " + std::to_string(rhs.z()) + "]"; }

std::string to_string(float2 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + "]"; }
std::string to_string(double2 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + "]"; }
std::string to_string(int2 rhs) { return "[ " + std::to_string(rhs.x()) + ", " + std::to_string(rhs.y()) + "]"; }
} // namespace detail
...
bool ParameterManager::parameterExists(std::string s) {
  if (parameterList.find(s) == parameterList.end())
    return false;
  return true;
}
...
#define VECTOR_PARSER(ty)                                                                                                                                                          \
  ...
  addUifunction(typeid(int32_t), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragInt(param.identifier.c_str(), &var);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(uint32_t), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragInt(param.identifier.c_str(), &vari, 1, 0, INT_MAX);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (varii != vari)
      var = (uint32_t)vari;
  ...
  addUifunction(typeid(float), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragFloat(param.identifier.c_str(), &var, var * 0.01f, -FLT_MAX, FLT_MAX, "%.6f");
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(double), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragFloat(param.identifier.c_str(), &vard, 0, 0.f, 0.f, "%.6f");
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (vard != vardd)
      var = vard;
  ...
  addUifunction(typeid(float4), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragFloat4(param.identifier.c_str(), &var.x(), 0.01f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(double4), [](Parameter &param) {
    ...
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (varb.x() != var.x() || varb.y() != var.y() || varb.z() != var.z() || varb.w() != var.w())
      vard = double4{(double)var.x(), (double)var.y(), (double)var.z(), (double)var.w()};
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(int4), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragInt4(param.identifier.c_str(), &var.x(), 1.f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(float3), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragFloat3(param.identifier.c_str(), &var.x(), 0.01f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(double3), [](Parameter &param) {
    ...
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (varb.x() != var.x() || varb.y() != var.y() || varb.z() != var.z())
      vard = double3{(double)var.x(), (double)var.y(), (double)var.z()};
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(int3), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragInt3(param.identifier.c_str(), &var.x(), 1.f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(float2), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragFloat2(param.identifier.c_str(), &var.x(), 0.01f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(double2), [](Parameter &param) {
    ...
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (varb.x() != var.x() || varb.y() != var.y())
      vard = double2{(double)var.x(), (double)var.y()};
    if (param.properties.presets.size() != 0) {
  ...
  addUifunction(typeid(int2), [](Parameter &param) {
    ...
    if (param.properties.range)
      ...
      ImGui::DragInt2(param.identifier.c_str(), &var.x(), 1.f);
    if (param.properties.description != "" && ImGui::IsItemHovered())
      ImGui::SetTooltip("%s", param.properties.description.c_str());
    if (param.properties.presets.size() != 0) {
...
Parameter &ParameterManager::getParameter(std::string identifier) {
  ...
  if (!parameterExists(qid))
    throw std::invalid_argument("Parameter " + identifier + " does not exist");
  return *parameterList[qid];
}
detail::varAny &ParameterManager::get(std::string identifier) { return getParameter(identifier).param; }
...
void ParameterManager::loadDirect(std::string yaml) { parseTree(YAML::Load(yaml)); }
void ParameterManager::loadTree(YAML::Node yaml) { parseTree(yaml); }
